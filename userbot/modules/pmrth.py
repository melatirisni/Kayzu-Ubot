...
async def typewriter(typew):
    ...
    await typew.edit(
        "**TERIMA KASIH PEMERINTAH PULANG DULU YA❤️❤️**
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**ASSALAMUALAIKUM PEMERINTAH HADIR UNTUK ANDA😘**
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**PEMERINTAH TERLALU OP🔥MAU DI ADU KAH MANIEZZ🤭**
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**PEMERINTAH OP ABIEZZZZZZZ...🔥 ADA LAWAN KAH NYET? 😏**
